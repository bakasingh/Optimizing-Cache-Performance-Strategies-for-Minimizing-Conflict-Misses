...
//apna code 
//this function prints the no of accesses in Access count file
void CACHE::printer(){
//apna code
    // Open a file for writing
    std::ofstream outFile("access_count.txt");


    // Traverse the map and write key-value pairs to the file
    for (const auto& pair : accessCount) {
        outFile << "Set " << pair.first << ": " << pair.second << " accesses\n";
    }
...
//apna code
    // Open a file for writing
    std::ofstream outFile("eviction_count.txt");


    // Traverse the map and write key-value pairs to the file

   outFile << "Size:  " <<evictionCount.size()<<endl;
    for (const auto& pair :evictionCount) {
        outFile << "Set " << pair.first << ": " << pair.second << " evictions\n";
    }
...
//apna code
    // Open a file for writing
    std::ofstream outFile("Set mapping.txt");
...
//     }
    for (int i = 0; i < Remap_Table.size(); ++i) {
        outFile <<"Set: "<<i<<" Mapped with : " <<Remap_Table[i] << "\n";
    }
...
//apna code
    // Open a file for writing
    std::ofstream outFile("Miss.txt");


    for (int i = 0; i < MissCount.size(); ++i) {
        outFile <<"Set: "<<i<<" Miss : " <<MissCount[i] << "\n";
    }
...
//apna code
    // Open a file for writing
    std::ofstream outFile("Linked.txt");



    for (int i = 0; i < linked.size(); ++i) {
        outFile <<"Set: "<<i<<" Mapped with : " <<linked[i] << "\n";
    }
...
int main(int argc, char** argv)
{
    ...
    uncore.LLC.printer4();
    uncore.LLC.printer6();
    //Here at the end of the simulation we are printing the access counts in access Count file
